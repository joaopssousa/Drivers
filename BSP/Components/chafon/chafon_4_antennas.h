...
#define END_PACK_BYTE			  	0x07
#define EARRING_START_BYTE		  	7
#define PACKAGE_SIZE			  	6
#define TAG_IDENTIFIER_INDEX	  	0
#define TAGS_DATA_SIZE 				START_BYTE_TAGS_DATA + 1
#define END_PACK_DATA_SIZE		  	END_BYTE_PACK_DATA + 1
...
typedef enum {
	ANTENNA1 = 0x80, ANTENNA2 = 0x81, ANTENNA3 = 0x82, ANTENNA4 = 0x83
} ANTENNAS;
